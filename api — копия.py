...
def handle_dialog(req, res):
    ...
    if req['request']['original_utterance'].lower() in [
        ...
        res['response']['text'] = 'Неправильный ответ! Знаменитые Ленские столбы возвышаются грозными утёсами на берегу одной из крупных рек Якутии. На какой реке они стоят?'
        res['response']['buttons'] = get_suggests(user_id, ['Индигирка', 'Лена', 'Калыма', 'Оленек'])
        return 

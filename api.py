...
cities = {
    'лена': ['Знаменитые Ленские столбы возвышаются грозными утёсами на берегу одной из крупных рек Якутии. На какой реке они стоят?', '1652229/2530bff99ec32a4bea34'],
    'волгоград': ['Форма этого памятника в виде трехгранного штыка. В каком городе он находится?', '213044/7a1793e70a7b6c5fc33b'],
    'брянск': ['Большевики мечтали снести этот памятник и вмест него воздвигнуть памятник Буденному или Фрунзе. В каком городе он установлен?', '213044/fbe06584fa2c82359c26'],
